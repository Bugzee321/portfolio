            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:contact@hossamahmed.com" className="text-gray-600 hover:text-primary">contact@hossamahmed.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-medium text-dark">Location</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-medium text-dark">Connect</h4>
